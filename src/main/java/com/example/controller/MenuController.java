...
public class MenuController {
    ...
    public String getMenu(HttpServletRequest request) {
		...
		if (1 == level) {
			...
			array.add(getJsonObject("sallerInfo", "商家信息", "layui-icon-table", "sallerInfo"));
			...
			array.add(getJsonObject("typeInfo", "土特产类别", "layui-icon-table", "typeInfo"));
			array.add(getJsonObject("goodsInfo", "土特产详情", "layui-icon-table", "goodsInfo"));
		...
		if (2 == level) {
			...
			array.add(getJsonObject("orderInfo", "订单信息", "layui-icon-table", "orderInfo"));
			array.add(getJsonObject("commentInfo", "评价信息", "layui-icon-table", "commentInfo"));
			array.add(getJsonObject("accountSallerInfo", "个人信息", "layui-icon-user", "accountSallerInfo"));
			tableObj.putOpt("list", array);
		}
    ...
    public Result<Map<String, Integer>> getTotle() {
		...
		resultMap.put("sallerInfo", sallerInfoService.findAll().size());
